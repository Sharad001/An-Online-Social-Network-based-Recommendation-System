...
# generate test data of unseen movies 
./GenerateTest

echo "generated input file, userid-unseen movie"
...
echo "Generated recommendation.txt recommending top 20 movies to each user"
